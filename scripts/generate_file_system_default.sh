...
#
# File:      generate_file_system_default.sh
#
...
#            file system using default parameters.
#
# Release notes:
#
...
source $SCRIPTSDIR/common/initialize.sh "generate_file_system_default"
if [ $? -ne 0 ]; then
  exit 1
fi

# Check for required sources
$SCRIPTSDIR/common/check_sources.sh 0 0 1 0 0 1
if [ $? -ne 0 ]; then
  echoandlog ""
...
$SCRIPTSDIR/common/generate_file_system_common.sh "default"
