...
#
# File:      generate_linux_kernel_custom.sh
#
...
#            Linux kernel using custom parameters.
#
# Release notes:
#
...
source $SCRIPTSDIR/common/initialize.sh "generate_linux_kernel_custom"
if [ $? -ne 0 ]; then
  exit 1
fi

# Check for required sources
$SCRIPTSDIR/common/check_sources.sh 0 1 0 0 0 0 0 0 1
if [ $? -ne 0 ]; then
  echoandlog ""
...
$SCRIPTSDIR/common/generate_linux_kernel_common.sh "custom"
